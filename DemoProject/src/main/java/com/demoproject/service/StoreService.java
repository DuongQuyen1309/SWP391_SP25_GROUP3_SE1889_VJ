...
public class StoreService {
    ...
    public void createStore(StoreDTO storeDTO) {
        ...
        store.setStoreId(storeDTO.getOwnerId()); // ✅ Gán Owner vào Store
        ...
        String ownerName = storeRepository.findOwnerNameByStoreId(store.getStoreId());
...
//    }
    ...
    public Store findStoreByAccount(String username) {
        ...
        if (accountOpt.isPresent()) {
            ...
            return storeRepository.findByStoreId(storeId); // Tìm Store theo storeId
        }
        return null;
    }
